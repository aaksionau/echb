...
urlpatterns = [
    ...
    path('about-us/online/', views.CurrentVideosListView.as_view(), name='online'),
    path('about-us/online/<slug:slug>/', views.VideoDetailView.as_view(), name='videos-by-filter'),
    path('about-us/online/<slug:slug>/thankyou/',
